...
import 'package:quadro_platform/features/request_details_screen/view/widgets/bottom_navigation_builder.dart';
import 'package:quadro_platform/features/request_details_screen/view/widgets/offer_details.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => DetailsCubit(
        ...
        ..initionlization(requestType: requestType, request: request),
      child: DetailsView(
...
class DetailsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final bool canRespond =
        context.select((DetailsCubit bloc) => bloc.state.canRespond);
    return PopScope(
      ...
      child: Scaffold(
        bottomNavigationBar: BottomNavigationBuilder(request: request),
