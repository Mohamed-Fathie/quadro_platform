...
class LocationButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final location = context.select(
      (WorkshopEditBloc bloc) => bloc.state.location,
    );
    ...
    return location == null
        ? CustomElevatedButton(
            ...
            onPressed: () async {
              ...
              if (result != null) {
                context
                    .read<WorkshopEditBloc>()
                    .updateLocation(result as SelectedLocation);
              }
            },
        ...
        : InkWell(
            onTap: () async {
              final result = await NavigationService().routeTo(
                  RoutesConstants.workshopLocationMap,
                  arguments: location.coordinates);
              if (result != null) {
                context
                    .read<WorkshopEditBloc>()
                    .updateLocation(result as SelectedLocation);
