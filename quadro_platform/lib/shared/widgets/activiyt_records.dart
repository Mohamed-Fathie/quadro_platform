...
class ActiviytRecords extends StatefulWidget {
  const ActiviytRecords({super.key});

  @override
  State<ActiviytRecords> createState() => _ActiviytRecordsState();
}

class _ActiviytRecordsState extends State<ActiviytRecords> {
  DatabaseReference tripHistory = FirebaseDatabase.instance
      .ref()
      .child('RiderRideHistory/${auth.currentUser!.uid}');
  ...
  Future<List<RiderRequistModel>> fetchSortedTrips() async {
    ...
    // تحويل الداتا إلى قائمة من RiderRequistModel
    ...
    // ترتيب القائمة حسب rideCreateTime من الأحدث إلى الأقدم
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<RiderRequistModel>>(
            ...
            return Container(
              ...
              decoration: BoxDecoration(
                border: Border(
                  bottom: BorderSide(
                      color:
                          index == trips.length - 1 ? transparent : greyShade3),
                ),
              ),
              height: 17.6.h,
              width: 94.w,
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image:
                            AssetImage(getVehicleImage(rideData.vehicleType)),
                      ),
                    ),
                  ),
                  SizedBox(width: 5.w),
